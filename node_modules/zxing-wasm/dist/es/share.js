...
const H = "2.1.0", N = "37b847798a1af55d3a289a9516a751fcafae3c23", W = {
  locateFile: (e, t) => {
    const r = e.match(/_(.+?)\.wasm$/);
    return r ? `https://fastly.jsdelivr.net/npm/zxing-wasm@2.1.0/dist/${r[1]}/${e}` : t + e;
  }
